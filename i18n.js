...
const I18N = {
  es: {
    ...
    wt_hint: 'Pega varias líneas con <code>Part Number, Manufacturador</code> (uno por línea). Te devuelve <strong>solo el peso unitario por pieza en mg</strong>. Usa el mismo backend conectado arriba.',
    wt_ph: "NE555P, Texas Instruments\nSTM32F103C8T6, ST\nGRM188R71C104KA01D, Murata",
    wt_btn: "Buscar pesos",
    wt_export: "⬇ Exportar CSV",
    wt_th_pn: "Part Number", wt_th_mfr: "Mfr", wt_th_weight: "Peso unit. (mg)", wt_th_status: "Estado",
  ...
  en: {
    ...
    wt_hint: 'Paste several lines with <code>Part Number, Manufacturer</code> (one per line). Returns <strong>only the unit weight per piece in mg</strong>. Uses the same backend connected above.',
    wt_ph: "NE555P, Texas Instruments\nSTM32F103C8T6, ST\nGRM188R71C104KA01D, Murata",
    wt_btn: "Get weights",
    wt_export: "⬇ Export CSV",
    wt_th_pn: "Part Number", wt_th_mfr: "Mfr", wt_th_weight: "Unit weight (mg)", wt_th_status: "Status",
